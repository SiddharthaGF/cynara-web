...
import { ChatMarkdownContent } from './ChatMarkdownContent.tsx';
...
/**
 * Memoized so a streaming delta on the active assistant turn does not
 * re-render every settled turn in the transcript.
 */
export const ChatTurnMessage = memo(
  ({
    turn,
    fieldsById,
    typesBySlug,
        ...
        <MessageContent>
          ...
          {showBody ? (
            ...
            >
              <BubbleContent
                className={cn(
                  'ai-chat-bubble-content text-[15px] leading-relaxed',
